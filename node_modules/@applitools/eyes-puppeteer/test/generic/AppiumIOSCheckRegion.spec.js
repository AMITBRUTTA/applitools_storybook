...
describe('Coverage Tests', () => {
  ...
  beforeEach(async () => {
    ...
    eyes = testSetup.getEyes({
      displayName: 'appium iOS check region',
      baselineName: 'Appium_iOS_CheckRegion',
  ...
  it('appium iOS check region (@native-selectors @native @mobile @headfull)', async () => {
    await eyes.open(
      driver,
      'Applitools Eyes SDK',
