...
describe.skip('Coverage Tests', () => {
  ...
  beforeEach(async () => {
    ...
    eyes = testSetup.getEyes({
      displayName: 'check frame with css stitching',
      stitchMode: 'CSS',
      baselineName: 'TestCheckFrame_Fluent',
  ...
  it('check frame with css stitching', async () => {
    await spec.visit(
      driver,
      'https://applitools.github.io/demo/TestPages/FramesTestPage/'
    )
    await eyes.open(driver, undefined, 'TestCheckFrame_Fluent', {
      width: 700,
      height: 460,
    })
