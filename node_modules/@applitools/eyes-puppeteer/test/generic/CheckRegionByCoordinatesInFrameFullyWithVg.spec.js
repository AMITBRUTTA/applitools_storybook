...
describe('Coverage Tests', () => {
  ...
  beforeEach(async () => {
    ...
    eyes = testSetup.getEyes({
      vg: true,
      displayName: 'check region by coordinates in frame fully with vg',
      baselineName: 'TestCheckRegionByCoordinateInFrameFully_Fluent_VG',
    })
  })
  afterEach(async () => {
  ...
  it('check region by coordinates in frame fully with vg', async () => {
    await spec.visit(
      driver,
