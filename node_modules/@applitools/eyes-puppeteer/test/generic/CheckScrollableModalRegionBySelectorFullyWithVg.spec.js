...
describe('Coverage Tests', () => {
  ...
  beforeEach(async () => {
    ...
    eyes = testSetup.getEyes({
      vg: true,
      displayName: 'check scrollable modal region by selector fully with vg',
      baselineName: 'TestCheckScrollableModal_VG',
    })
  })
  afterEach(async () => {
  ...
  it('check scrollable modal region by selector fully with vg', async () => {
    await spec.visit(
      driver,
