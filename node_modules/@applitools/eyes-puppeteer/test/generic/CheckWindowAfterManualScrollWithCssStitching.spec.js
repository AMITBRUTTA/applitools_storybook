...
describe('Coverage Tests', () => {
  ...
  beforeEach(async () => {
    ...
    eyes = testSetup.getEyes({
      displayName: 'check window after manual scroll with css stitching',
      stitchMode: 'CSS',
      baselineName: 'TestCheckWindowAfterScroll',
    })
  })
  afterEach(async () => {
  ...
  it('check window after manual scroll with css stitching', async () => {
    await spec.visit(
      driver,
