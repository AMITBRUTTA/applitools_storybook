...
describe('Coverage Tests', () => {
  ...
  beforeEach(async () => {
    ...
    eyes = testSetup.getEyes({
      vg: true,
      displayName: 'check window fully with custom scroll root with vg',
      baselineName: 'TestCheckWindow_Body_VG',
    })
  })
  afterEach(async () => {
  ...
  it('check window fully with custom scroll root with vg', async () => {
    await spec.visit(
      driver,
