...
describe('Coverage Tests', () => {
  ...
  beforeEach(async () => {
    ...
    eyes = testSetup.getEyes({
      vg: true,
      displayName: 'should hide and restore scrollbars with vg',
      baselineName: 'TestScrollbarsHiddenAndReturned_Fluent_VG',
    })
  })
  afterEach(async () => {
  ...
  it('should hide and restore scrollbars with vg', async () => {
    await spec.visit(
      driver,
