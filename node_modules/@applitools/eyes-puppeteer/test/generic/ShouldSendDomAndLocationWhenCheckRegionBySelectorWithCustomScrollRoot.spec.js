// should send dom and location when check region by selector with custom scroll root
...
describe('Coverage Tests', () => {
  ...
  beforeEach(async () => {
    ...
    eyes = testSetup.getEyes({
      displayName:
        'should send dom and location when check region by selector with custom scroll root',
      baselineName:
        'ShouldSendDomAndLocationWhenCheckRegionBySelectorWithCustomScrollRoot',
    })
  })
  afterEach(async () => {
  ...
  it('should send dom and location when check region by selector with custom scroll root', async () => {
    await spec.visit(
      driver,
    ...
    await eyes.check({region: '#modal-content', scrollRootElement: '#modal1'})
