// should send floating region by selector with vg
...
describe.skip('Coverage Tests', () => {
  ...
  beforeEach(async () => {
    ...
    eyes = testSetup.getEyes({
      vg: true,
      displayName: 'should send floating region by selector with vg',
      baselineName: 'TestCheckWindowWithFloatingBySelector_Fluent_VG',
    })
  })
  afterEach(async () => {
  ...
  it('should send floating region by selector with vg', async () => {
    await spec.visit(
      driver,
