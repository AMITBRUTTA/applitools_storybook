// should send ignore region by coordinates in target region with vg
...
describe('Coverage Tests', () => {
  ...
  beforeEach(async () => {
    ...
    eyes = testSetup.getEyes({
      ...
      displayName:
        'should send ignore region by coordinates in target region with vg',
      baselineName: 'TestCheckRegionWithIgnoreRegion_Fluent_VG',
    })
  })
  afterEach(async () => {
  ...
  it('should send ignore region by coordinates in target region with vg', async () => {
    await spec.visit(
      driver,
