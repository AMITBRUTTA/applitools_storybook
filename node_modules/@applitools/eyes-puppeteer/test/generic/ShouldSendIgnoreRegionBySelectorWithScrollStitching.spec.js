// should send ignore region by selector with scroll stitching
...
describe('Coverage Tests', () => {
  ...
  beforeEach(async () => {
    ...
    eyes = testSetup.getEyes({
      displayName:
        'should send ignore region by selector with scroll stitching',
      stitchMode: 'Scroll',
      baselineName: 'TestCheckWindowWithIgnoreBySelector_Fluent_Scroll',
    })
  })
  afterEach(async () => {
  ...
  it('should send ignore region by selector with scroll stitching', async () => {
    await spec.visit(
      driver,
