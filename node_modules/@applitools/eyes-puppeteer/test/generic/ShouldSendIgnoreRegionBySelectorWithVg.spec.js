// should send ignore region by selector with vg
...
describe.skip('Coverage Tests', () => {
  ...
  beforeEach(async () => {
    ...
    eyes = testSetup.getEyes({
      vg: true,
      displayName: 'should send ignore region by selector with vg',
      baselineName: 'TestCheckWindowWithIgnoreBySelector_Fluent_VG',
    })
  })
  afterEach(async () => {
  ...
  it('should send ignore region by selector with vg', async () => {
    await spec.visit(
      driver,
